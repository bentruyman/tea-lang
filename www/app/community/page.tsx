...
const channels = [
  {
    ...
    kicker: "Source code",
    description:
      "Browse the compiler, stdlib, examples, and docs directly in the main repo.",
    href: repo.url,
    icon: GitBranch,
  ...
  },
  {
    ...
    description:
      "Report bugs, request improvements, and track documentation or compiler work.",
  ...
  },
  {
    ...
    kicker: "Conversation",
    description:
      "Use discussions for design questions, examples, and general Tea workflow talk.",
...
const steps = [
  {
    ...
    description:
      "Understand the build system, test flow, and code style before jumping in.",
  ...
  },
  {
    ...
    description:
      "Find bugs, feature requests, and documentation tasks that need attention.",
    href: `${repo.url}/issues`,
    external: true,
  },
  {
      ...
      <section className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
        <div className="space-y-4">
          ...
          <p className="max-w-xl text-lg leading-8 text-muted-foreground">
            Whether you're fixing a bug, adding a stdlib module, or improving
            the docs, the path is the same: fork, build, test, PR.
          </p>
