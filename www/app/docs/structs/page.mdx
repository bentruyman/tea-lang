...
>
  ...
  <NoteCard title="Current model">
    The checked-in sources use <code>struct</code>, not classes. Construction is explicit, fields are named, and generic structs use square-bracket type parameters such as <code>Box[T]</code>.
  </NoteCard>
