...
export function KeyConceptCard({ title, children, className }: KeyConceptCardProps) {
  return (
...
export function FeaturePill({ kicker, title, children, className }: FeaturePillProps) {
  return (
    <div className={cn("surface-quiet rounded-2xl border border-border/70 p-4", className)}>
