/* @ts-self-types="./tea_web.d.ts" */

/**
 * @param {any} value
 * @returns {any}
 */
export function run_tea(value) {
  const ret = wasm.run_tea(value);
  if (ret[2]) {
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === undefined) {
    module_or_path = new URL("tea_web_bg.wasm", import.meta.url);
  }
  const imports = __wbg_get_imports();
